...
class Tests(unittest.TestCase):
    ...
    def test_check_sequence_given_two_tosses(self):
        ...
        THEN: function returns False
        """
        self.assertFalse(check_sequence('TTH', 'TH'))
    ...
    def test_check_victory_player_one(self):
        ...
        """
        self.assertEqual(check_victory('TTH', 'TTT', 'TTH'), Situation.p1_wins)
    ...
    def test_check_victory_player_two(self):
        ...
        """
        self.assertEqual(check_victory('TTH', 'TTT', 'TTT'), Situation.p2_wins)
    ...
    def test_check_victory_of_nobody(self):
        ...
        """
        self.assertEqual(check_victory('TTH', 'TTT', ''), Situation.nobody_won_yet)
    ...
    def test_check_victory_player_one_with_longer_sequence(self):
        ...
        THEN: function returns player 1 won
        """
        self.assertEqual(check_victory('TTH', 'TTT', 'HHHTTH'), Situation.p1_wins)
    ...
    def test_gamemove_appending_to_sequence(self):
        ...
        self.assertEqual(gamemove(1, 'TTT', 'TTH', '')[1], Situation.nobody_won_yet)
    ...
    def test_gamemove_victory_player_one(self):
        ...
        THEN: function returns player 1 won
        """
        self.assertEqual(gamemove(0, 'TTH', 'TTT', 'TT')[1], Situation.p1_wins)
    ...
    def test_gamemove_victory_player_two(self):
        ...
        THEN: function returns player 2 won
        """
        self.assertEqual(gamemove(1, 'TTH', 'TTT', 'TT')[1], Situation.p2_wins)
